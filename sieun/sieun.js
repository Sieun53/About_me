...
document.addEventListener('DOMContentLoaded', function() {
  // 여러 선택자를 사용하여 링크를 선택
  var links = document.querySelectorAll('.link-sns a, .project-list a');
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const offset = 100; // 스크롤이 얼마나 더 일찍 발생할지 픽셀 단위로 설정
  const sectionAboutTop = sectionAbout.offsetTop - offset;
